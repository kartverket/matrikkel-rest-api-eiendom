...
# used to generate the correct url for the interactive swagger-functionality
# 'BASE_URL' is automatically set in the uwsgi-config on the servers.
servers = []
...
spec = APISpec(
    ...
    servers=servers,
    info=dict(
        description="""API fra Kartverket for geokoding eller lokalisering av eiendommer. Finn eiendommer ved en posisjon, eller finn posisjonen til et matrikkelnummer.
